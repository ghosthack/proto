...
package turismo.action;

import javax.servlet.ServletContext;
import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;

import turismo.action.behavior.Alias;
import turismo.action.behavior.MovedPermanently;
import turismo.action.behavior.MovedTemporarily;
import turismo.action.behavior.NotFound;
import turismo.action.behavior.Redirect;
import turismo.action.behavior.StringPrinter;
